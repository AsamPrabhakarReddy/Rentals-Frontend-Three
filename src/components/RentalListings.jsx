    ...
    <div className='w-full h-screen lg:mt-[20px] mt-[100px]'>
        <div className="max-w-[1400px] lg:mx-auto mx-[10px] h-screen grid lg:grid-cols-2 pb-10">
          <div className="p-8 flex flex-col justify-center">
            <h1 className="lg:text-[47px] text-[35px] font-bold text-start font-semibold leading-tight text-mainColor">
              List your rental property for free across RMA Housing and top rental sites.
            </h1>

            <p className="lg:text-[25px] text-[20px] text-start text-gray-500 leading-relaxed mt-8">
              Fill vacant units quickly by showcasing your rental listing to millions of potential renters with just one click.
            </p>
