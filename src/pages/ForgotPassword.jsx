                        ...
                        <div className="w-full bg-white rounded shadow md:mt-0 lg:max-w-md">
                          <div className="p-6 space-y-4">
                            ...
                            >
                              ...
                              <button
                                type="submit"
                                className="w-full border border-mainColor text-white bg-mainColor hover:bg-white hover:text-mainColor transition ease-in-out duration-1000 font-medium rounded text-sm px-5 py-2.5 text-center cursor-pointer"
                              >
                                Submit
                              </button>
